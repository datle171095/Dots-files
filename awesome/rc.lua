...
-- {{{ Tags
tags = {
    names = { "start", "2", "3", "4", "5", "other"},
    layout = { layouts[5], layouts[1], layouts[3], layouts[3], layouts[1], layouts[5]}
}
...
myawesomemenu = {
	...
	{ "edit config", "gedit /home/datle/.config/awesome/rc.lua" },
...
volumewidget = lain.widgets.alsa({
	...
	widget:set_markup(markup("#93B6FF",volume_now.level .. "% "))
	end
})
volicon:buttons(awful.util.table.join(
	awful.button({ }, 1, function() awful.util.spawn("alsamixer") end),
	awful.button({ }, 3,
		function ()
...
globalkeys = awful.util.table.join(
	...
	-- Applications
	awful.key({ altkey }, "f", function () awful.util.spawn(browser) end),
	awful.key({ altkey }, "t", function () awful.util.spawn(file_browser) end),
	awful.key({ altkey }, "g", function () awful.util.spawn(gui_editor) end),
  ...
  --Pulse volume control
	awful.key({	}, "XF86AudioRaiseVolume",function () awful.util.spawn_with_shell("pactl set-sink-volume 1 +5%", volumewidget.channel)
	  volumewidget.update()
	end),
	awful.key({	}, "XF86AudioLowerVolume",function () awful.util.spawn_with_shell("pactl set-sink-volume 1 -5%", volumewidget.channel)
	  volumewidget.update()
	end),
	awful.key({	}, "XF86AudioMute",function () awful.util.spawn_with_shell("pactl set-sink-mute 1 toggle", volumewidget.channel)
	  volumewidget.update()
	end),
